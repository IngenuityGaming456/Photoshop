...
var CreateLocalisationStructure = /** @class */ (function () {
    ...
    CreateLocalisationStructure.prototype.modifySelectedResponse = function (idsArray) {
        return __awaiter(this, void 0, void 0, function () {
            var toSpliceIndexes, idsArray_1, idsArray_1_1, item, genSettings, button, e_1_1;
            var e_1, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    CreateLocalisationStructure.prototype.getParents = function (idsArray) {
        return __awaiter(this, void 0, void 0, function () {
            var idsMap, idsArray_2, idsArray_2_1, item, parents;
            var e_2, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    CreateLocalisationStructure.prototype.handleResponse = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var responseArray, responseArray_1, responseArray_1_1, item, responseSubArray, e_3_1;
            var e_3, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
